...
class unibham:
    ...
    def run(self):
        ...
        for article in articles:
            ...
            a["link"] = self.link_parse(str(article.a).split("\"")[1])
            ...
            for f in full_head:
                if f not in detail_head:
                    ...
                    if f == 'dates':
                        good_date = self.date_parse(details[count].text)
        ...
        path = os.getcwd()+"/University of Birmingham.csv"
